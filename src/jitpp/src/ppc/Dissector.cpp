...
void Dissector::dissectSpecial(ppc_op op)
{
	...
	case 202: onAddze(op.xo_rt(), op.xo_ra(), false, op.rc());             break;
	...
	case 714: onAddze(op.xo_rt(), op.xo_ra(), true, op.rc());              break;
...
void Dissector::dissectTable13(ppc_op op)
{
	...
	case 25: onFmuls(op.a_frt(), op.a_fra(), op.a_frc(), op.rc());              break;

	case 28: onFmsubs(op.a_frt(), op.a_fra(), op.a_frc(), op.a_frb(), op.rc()); break;
...
void Dissector::dissectTable14(ppc_op op)
{
	...
	case 28: onFmsub(op.a_frt(), op.a_fra(), op.a_frc(), op.a_frb(), op.rc());  break;
...
void Dissector::dissectTable14_x_form(ppc_op op)
{
	...
	case 72:  onFmr(op.x_frt(), op.x_frb(), op.rc());     break;
