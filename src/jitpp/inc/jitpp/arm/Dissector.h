...
protected:
	...
	virtual void onAddImm(CC cc, bool s, int rd, int rn, uint32_t imm) = 0;
	virtual void onAndImm(CC cc, bool s, int rd, int rn, uint32_t imm) = 0;
	...
	virtual void onMovReg(CC cc, bool s, int rd, int rm) = 0;
